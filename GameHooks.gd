...
# `player` is the fighter. (FighterHooks.action_selected is the same event on the
# fighter itself. The UI-side pick lives in main.gd, which mods extend directly.)
